...
UPDATES = [
    ...
    {"title": "How the Internet Works", "type": "video", "youtubeId": "x3c1ih2NJEg", "duration": "8:58"},
    {"title": "What Happens When You Type a URL", "type": "video", "youtubeId": "AlkDbnbv7dk", "duration": "5:20"},
    {"title": "What is a Website", "type": "article", "readTime": "4 min"},
    {"title": "How Browsers Render Pages", "type": "article", "readTime": "6 min"},
    {"title": "HTML Crash Course", "type": "video", "youtubeId": "UB1O30fR-EE", "duration": "1:00:42"},
    {"title": "Understanding Semantic HTML", "type": "video", "youtubeId": "YOsMJQfwqow", "duration": "9:32"},
    {"title": "Core HTML Tags", "type": "article", "readTime": "5 min"},
    {"title": "HTML Page Structure", "type": "article", "readTime": "4 min"},
    {"title": "CSS Basics", "type": "video", "youtubeId": "JnTPd9G6hoY", "duration": "28:58"},
    {"title": "Understanding the CSS Box Model", "type": "video", "youtubeId": "M6coJNLFBWI", "duration": "18:52"},
    {"title": "Fonts and Colors", "type": "article", "readTime": "5 min"},
    {"title": "Basic Layout Concepts", "type": "article", "readTime": "6 min"},
    {"title": "JavaScript Fundamentals", "type": "video", "youtubeId": "W6NZfCO5SIk", "duration": "48:17"},
    {"title": "DOM Manipulation", "type": "video", "youtubeId": "y17RuWkWdn8", "duration": "18:37"},
    {"title": "JavaScript Events", "type": "article", "readTime": "7 min"},
    {"title": "Connecting JavaScript with HTML", "type": "article", "readTime": "5 min"},
    {"title": "Frontend vs Backend", "type": "video", "youtubeId": "1mXrxc_sv1o", "duration": "1:15"},
    {"title": "Introduction to APIs", "type": "video", "youtubeId": "WXsD0ZgxjRw", "duration": "3:07:06"},
    {"title": "Client Server Architecture", "type": "article", "readTime": "6 min"},
    {"title": "Deploying Your Work", "type": "article", "readTime": "8 min"},
    
    # DSA
    {"title": "What is Programming Logic", "type": "video", "youtubeId": "4xh1Vek9vnk", "duration": "16:12"},
    {"title": "Computational Thinking", "type": "video", "youtubeId": "0JUN9aDxVmI", "duration": "1:28:19"},
    {"title": "Algorithms Explained", "type": "article", "readTime": "5 min"},
    {"title": "Steps in Problem Solving", "type": "article", "readTime": "6 min"},
    {"title": "Understanding Variables", "type": "video", "youtubeId": "KpJ385shzgM", "duration": "3:52"},
    {"title": "Inputs and Outputs", "type": "video", "youtubeId": "aiM2Y87umr4", "duration": "5:26"},
    {"title": "Basic Data Types", "type": "article", "readTime": "4 min"},
    {"title": "Updating Values", "type": "article", "readTime": "3 min"},
    {"title": "If Statements", "type": "video", "youtubeId": "HQ3dCWjfRZ4", "duration": "10:56"},
    {"title": "Decision Making in Programs", "type": "video", "youtubeId": "aK3C3j6xI6c", "duration": "6:10"},
    {"title": "If vs If Else", "type": "article", "readTime": "5 min"},
    {"title": "Nested Conditions", "type": "article", "readTime": "6 min"},
    {"title": "For Loops", "type": "video", "youtubeId": "KWgYha0clzw", "duration": "5:05"},
    {"title": "While Loops", "type": "video", "youtubeId": "qUPXsPtWGoY", "duration": "6:49"},
    {"title": "Iteration Concepts", "type": "article", "readTime": "5 min"},
    {"title": "Avoiding Infinite Loops", "type": "article", "readTime": "4 min"},
    {"title": "What is an Algorithm", "type": "video", "youtubeId": "rL8X2mlNHPM", "duration": "11:44"},
    {"title": "Designing Efficient Steps", "type": "video", "youtubeId": "rL8X2mlNHPM", "duration": "11:44"},
    {"title": "Intro to Time Complexity", "type": "article", "readTime": "7 min"},
    {"title": "Combining Loops and Conditions", "type": "article", "readTime": "6 min"},
]
        ...
        for item in UPDATES:
            ...
            if topic_type == "video":
                ...
                content_json = {
                    ...
                    "duration": item.get("duration", "10 min"),
                ...
                content_json = {
                    "content": content,
                    "readTime": item.get("readTime", "10 min")
                }
                json_str = json.dumps(content_json).replace("'", "''")
                safe_title = title.replace("'", "''")
                f.write(f"    UPDATE public.topics SET content_data = '{json_str}'::jsonb WHERE title = '{safe_title}';\n")
