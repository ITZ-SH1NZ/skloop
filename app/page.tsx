...
const FeatureLevels = dynamic(() => import("@/components/marketing/FeatureLevels"), { ssr: false });
const ExpandedSections = dynamic(() => import("@/components/marketing/ExpandedSections"), { ssr: false });
